...
?>
	<?php if($tlContentFrom == 'tlrepeater'){ 
 			   $excerpt = ""; 
	        if($descByLimit == 'default'){ ?>
	  	        <div class="entry-content scroll-<?php echo esc_attr($cntscrollOn); ?>"><?php echo $testimonial_author_text; ?></div>
	    <?php 
	        }else{ 
...
<div class="entry-content">
	<?php if($tlContentFrom == 'tlrepeater'){ ?>
		<?php echo $excerpt; ?>
	<?php }else{?>
		<?php echo $testimonial_author_text; ?>
	<?php }?>
</div>
<?php } ?>