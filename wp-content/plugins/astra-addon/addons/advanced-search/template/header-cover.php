		...
		<div class="ast-container">
			<form class="search-form" action="<?php echo esc_url( home_url() ); ?>/" method="get">
				<span class="search-text-wrap">
					...
					<input id="search-field" name="s" class="search-field" type="text" autocomplete="off" value="" placeholder="<?php echo esc_attr( astra_default_strings( 'string-header-cover-search-placeholder', false ) ); ?>">
				</span>
